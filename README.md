...
<b>minhash:</b><br>
MinHash object containing minhash signatures for new texts, parameters must match any MinHash objects previously used.<br>
<b>new_labels:</b><br>
List, array or Pandas series containing text labels.<br><br>
<b>query</b><br>
